...
def kg_to_lb(kg):
    ...
    if kg < 0:
        raise ValueError ("El valor introducido debe ser mayor o igual a '0'")
    if not isinstance(kg, int):
        raise TypeError ("El valor introducido debe ser un valor entero")
    

    conversion_libras = 2.2046

    return kg * conversion_libras
